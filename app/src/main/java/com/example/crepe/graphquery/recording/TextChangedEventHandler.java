...
import com.example.crepe.graphquery.model.block.util.SugiliteAvailableFeaturePack;
...
public class TextChangedEventHandler {
    ...
    private com.example.crepe.graphquery.recording.SugiliteScreenshotManager screenshotManager;
    ...
    public TextChangedEventHandler(SugiliteData sugiliteData, Context context, SharedPreferences sharedPreferences, android.os.Handler uiThreadHandler){
        ...
        this.screenshotManager = com.example.crepe.graphquery.recording.SugiliteScreenshotManager.getInstance(sharedPreferences, sugiliteData);
    }
    ...
    public void handle(SugiliteAvailableFeaturePack featurePack, Set<Map.Entry<String, String>> availableAlternatives){
        ...
        if(belongsToTheSameSession(aggregatedFeaturePack, featurePack)){
            ...
            if (aggregatedFeaturePack.screenshot == null) {
                aggregatedFeaturePack.screenshot = screenshotManager.takeScreenshot(com.example.crepe.graphquery.recording.SugiliteScreenshotManager.DIRECTORY_PATH, screenshotManager.getFileNameFromDate(), 0);
            }
