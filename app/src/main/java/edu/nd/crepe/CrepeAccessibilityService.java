                            ...
                            for (SugiliteEntity result : currentResults) {
                                ...
                                Log.i("query execution", "prevResults.contains(result): " + prevResults.contains(result));
                                    if (!prevResults.contains(result)) {
                                        ...
                                        Data resultData = new Data(datafield.getCollectorId() + "%" + timestamp, datafield.getDataFieldId(), MainActivity.firebaseInstallationId, result.saveToDatabaseAsString());
